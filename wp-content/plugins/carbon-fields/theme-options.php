...
Container::make('theme_options', 'Контакты')
        ...
        ->add_tab(__('Контакты'), array (
            Field::make('text', 'crb_header-link', 'Текст кнопки')
            ->set_width(50),
            Field::make('text', 'crb_header-link_link', 'Ссылка на номер')
            ->help_text('ссылка на мессенджер')
            ->set_width(50),
            Field::make('image', 'crb_header-link_img', 'Иконка')
            ->set_width(33),
